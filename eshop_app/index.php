...
<? $APPLICATION->IncludeComponent(
    ...
    <div class="maincontent_component">
        <div class="main_button_component">
            <a href="javascript:void(0)" id="saleleader_title" class="current"
               onclick="BX('saleleaders_block').style.display='block'; BX('newproduct_block').style.display='none';BX.removeClass(BX('newproduct_title'), 'current'); BX.addClass(BX(this), 'current');">Хиты
                продаж<span></span></a>
            <a href="javascript:void(0)" id="newproduct_title"
               onclick="BX('saleleaders_block').style.display='none'; BX('newproduct_block').style.display='block';  BX.removeClass(BX('saleleader_title'), 'current'); BX.addClass(BX(this), 'current');">Новинки<span></span></a>
            <a href="javascript:void(0)" class="main_button_catalog"
               onclick="openSectionList();">Каталог<span></span></a>
            <div class="clb"></div>
        </div>
